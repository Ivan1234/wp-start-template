<?php
/*
Widget Name: Top Post
Description: This widget add small icons before text
Author: Ivan Khuda
*/

class Top_Post_Widget extends SiteOrigin_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            __('Top Post', 'top-post-widget-text-domain'),

            // The $widget_options array, which is passed through to WP_Widget.
            // It has a couple of extras like the optional help URL, which should link to your sites help or support page.
            array(
                'description' => __('Top Post widget.', 'top-post-widget-text-domain')
            ),
            ...
            array(
                'a_repeater' => array(
                    'type' => 'repeater',
                    'label' => __( 'Post repeater' , 'widget-form-fields-text-domain' ),
...
siteorigin_widget_register( 'top-post', __FILE__, 'Top_Post_Widget' );
?>